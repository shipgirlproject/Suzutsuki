...
public class SuzutsukiRoutes {
    ...
    public void triggerFail(RoutingContext context) {
        ...
        this.logger.warn("Failed REST Request; Code: " + statusCode + " Error: ", throwable);
        ...
        try {
            switch (endpoint) {
                ...
                case "/patreons/check/user":
                    this.checkUserPatreonStatus(request, response, context);
                    break;
                case "/patreons/check/guild":
                    this.checkGuildPatreonStatus(request, response, context);
                    break;
                case "/patreons":
    ...
    private void checkGuildPatreonStatus(HttpServerRequest request, HttpServerResponse response, RoutingContext context) {
    ...
    private void checkUserPatreonStatus(HttpServerRequest request, HttpServerResponse response, RoutingContext context) {
